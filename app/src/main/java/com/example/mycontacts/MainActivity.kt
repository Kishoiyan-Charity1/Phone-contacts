...
class MainActivity : AppCompatActivity() {
    ...
    fun displayContacts(){
        var contacts =Contacts (name = "Allan", phone = "12345678", email = "aaa@hamail", address = "123 Nandi", image = "https://images.pexels.com/photos/2876486/pexels-photo-2876486.png?auto=compress&cs=tinysrgb&w=400")
        ...
        var contacts4 =Contacts (name = "Emon", phone = "12345672", email = "uuu@hamail", address = "123 Narok", image = "https://images.pexels.com/photos/4654759/pexels-photo-4654759.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load")
